...
class BME68X_AI(BME68X):
    ...
    def __init__(self, i2c_addr: int, ai_conf: str, index=0):
        ...
        with open('2021_01_15_20_56_Board_84CCA811FA3C_PowerOnOff_1_63lia0cvtdr8jz18_File_0.bmerawdata', 'r') as file:
            ...
            try:
                ...
                for i in range(self.duty_cycle['numberScanningCycles']):
                    ...
                    for hp_step in raw_data:
                        ...
                        output_data.append(int(round(time())))  # unix time stamp
...
if __name__ == '__main__':
    ai_conf = '2021_07_11_17_48_BoardConfiguration.bmeconfig'
